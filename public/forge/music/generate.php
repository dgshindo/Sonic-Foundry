...
try {
    ...
    respondJson(
        [
            ...
            'error' => [
                'code' =>
                    'MUSIC_STYLE_PROMPT_GENERATION_REJECTED',
    ...
    error_log(
        sprintf(
            'Music Style Prompt generation failed for work %d: %s in %s:%d',
            $workId,
            $error->getMessage(),
            $error->getFile(),
            $error->getLine(),
    ...
    respondJson(
        [
            ...
            'error' => [
                'code' =>
                    'MUSIC_STYLE_PROMPT_GENERATION_FAILED',

                'message' => (
                    'The Music Style Prompt could not be generated. '
                    . 'Your creative artifacts remain safely saved.'
                ),
            ],
        ],
        500
