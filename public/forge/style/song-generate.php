...
try {
    ...
    respondJson(
        [
            ...
            'error' => [
                'code' =>
                    'SONG_STYLE_GENERATION_REJECTED',
    ...
    error_log(
        sprintf(
            'Song Style Addendum generation failed for work %d: %s in %s:%d',
            $workId,
            $error->getMessage(),
            $error->getFile(),
            $error->getLine(),
    ...
    respondJson(
        [
            ...
            'error' => [
                'code' =>
                    'SONG_STYLE_GENERATION_FAILED',

                'message' => (
                    'The Song Style Addendum could not be generated. '
